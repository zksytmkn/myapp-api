...
RSpec.describe "Api::V1::ProductUnfavorites", type: :request do
  ...
  describe "GET /index" do
    before do
      get "/api/v1/product_unfavorites"
    end
  ...
  describe "POST /create" do
    ...
    context "with valid parameters" do
      before do
        post "/api/v1/product_unfavorites", params: { product_unfavorite: valid_attributes }
      end

      it "creates a new product_unfavorite" do
        expect(response).to have_http_status(:created)
        expect(ProductUnfavorite.count).to eq(2)
      end
    end

    context "with invalid parameters" do
      before do
        post "/api/v1/product_unfavorites", params: { product_unfavorite: invalid_attributes }
      end
  ...
  describe "DELETE /destroy" do
    before do
      delete "/api/v1/product_unfavorites/#{product.id}"
    end
