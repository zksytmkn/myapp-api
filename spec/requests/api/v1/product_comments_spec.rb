...
RSpec.describe "Api::V1::ProductComments", type: :request do
  ...
  describe "GET /index" do
    before do
      get "/api/v1/products/#{product.id}/product_comments"
    end
  ...
  describe "POST /create" do
    context "with valid parameters" do
      before do
        post "/api/v1/products/#{product.id}/product_comments", params: { product_comment: { content: "This is a comment" } }
      end
    ...
    context "with invalid parameters" do
      before do
        post "/api/v1/products/#{product.id}/product_comments", params: { product_comment: { content: "" } }
      end
  ...
  describe "DELETE /destroy" do
    before do
      delete "/api/v1/products/#{product.id}/product_comments/#{product_comment.id}"
    end
