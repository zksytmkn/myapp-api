...
RSpec.describe "Api::V1::OrderDetails", type: :request do
  ...
  describe 'PATCH #update' do
    context 'with valid parameters' do
      let(:valid_params) { { order_detail: { status: 'shipped' } } }

      it 'updates the order detail' do
        patch "/api/v1/order_details/#{order_detail.id}", params: valid_params
    ...
    context 'with invalid parameters' do
      ...
      it 'does not update the order detail' do
        patch "/api/v1/order_details/#{order_detail.id}", params: invalid_params
    ...
    context 'with non-existent order detail id' do
      it 'returns a not found error' do
        patch "/api/v1/order_details/9999999", params: valid_params
